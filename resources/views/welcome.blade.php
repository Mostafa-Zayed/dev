                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 start-home-content">
                            <h1>
                                We Made our Software <br>
                                Fully 100% Errorless!
                            </h1>
                            <p>Super clean, minimalistic, stylized mockup collection with awesome customization features and huge resolution and very useful for your business you can download it in each store.</p>
                        ...
                        <div class="col-md-6 start-home-img">
                            <img class="img-fluid" src="images/banner-2.png" alt="Img"/>
                        </div>
                    </div>
                </div>
            </div>
