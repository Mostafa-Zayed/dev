            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a href="#" data-scroll-nav="7">{{__('lang.v1.reviews')}}</a></li>
                        <li class="nav-item"><a href="#" data-scroll-nav="6">{{__('lang.v1.faqs')}}</a></li>
                        <li class="nav-item"><a href="#" data-scroll-nav="8">{{__('lang.v1.contact')}}</a></li>
