            ...
            <div class="container-fluid">
                <div class="login-side-block">
                    <div class="row align-items-baseline">
                        <div class="col-md-6">
                            <a href="{{ url('/') }}"><img src="{{ asset('front/images/erp_logo.png') }}" alt="Logo" style="width:170px;height:100px" /></a>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="col-md-8">
            <div class="container-fluid">
                ...
                <div class="login-form">
                    ...
                    {!! Form::hidden('package', request()->package,['id' => 'package_id']); !!}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="contact_no" id="contact_no" placeholder="Your Phone" aria-label="Email address" required>
