...
<body>
    ...
    <div class="col-md-8">
        <div class="container-fluid">
            <a href="index.html" class="res-logo"><img src="{{ asset('front/images/logo-2.png') }}"
                    alt="Logo" /></a>
            <div class="login-form">
                ...
                {!! Form::open(['url' => route('business.postRegister'), 'method' => 'post', 'id' => 'business_register_form']) !!}
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="businessName">{{ __('lang_v1.business_name') }}:
                                *</label>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="name" id="businessName"
                                    placeholder="{{ __('lang_v1.business_name') }}" aria-label="Email address"
                                    required="">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"
                                for="contact_no">{{ __('lang_v1.business_telephone') }}</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="contact_no" id="contact_no"
                                    placeholder="Your Phone" aria-label="Email address" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="first_name" id="first_name"
                                    placeholder="{{ __('lang_v1.full_name') }}" aria-label="Full Name"
                                    required="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"
                                for="password_confirmation">{{ __('business.confirm_password') }}: *</label>
                            <div class="input-group">
                                <div class="input-icon">
                                    <span class="ti-lock"></span>
                                </div>
                                <input type="password" class="form-control" name="password_confirmation"
                                    id="password_confirmation" aria-label="Password" required="">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('currency_id', $currencies, '', [
                                'class' => 'custom-select select2_register currency',
                                'id' => 'currency_id',
                ...
                <div class="form-group">
                    <p class="checkboxes">
                        ...
                        <label for="check-er">{{ __('lang_v1.agree') }} <a href="#" data-toggle="modal"
                                data-target="#tc_modal"> @lang('lang_v1.accept_terms_and_conditions')</a></label>
                    </p>
                </div>
                <div class="form-group">
                ...
                <div class="form-group login-desc">
                    <p> {{ __('lang_v1.have_account') }} <a
                            href="{{ route('login') }}">{{ __('lang_v1.login') }}</a></p>
                </div>
                {!! Form::close() !!}
            </div>
...
<div class="modal fade" id="rrt" tabindex="-1" role="dialog" aria-labelledby="subscriptionModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>بند 1: تلتزم شركة ERP TEC بعدم افشاء أسرار او بيانات العميل المشترك المقدمة له أو التي يطلع عليها
                    من خلال فترة الاشتراك بالبرنامج او بعدها.</p>
                <p>بند 2: لا يجوز للعميل المشترك تجزئة الاشتراك، وعليه دفع الباقة كاملة مقدما.</p>
                <p>بند 3: يعتبر التدريب المقدم من شركة فوالا هو خدمة مدفوعة ولها الحق في مطالبة العميل المشترك بها
                    في أي وقت في العام الأول من الاشتراك، وبعد العام الأول يسقط هذا الحق.</p>
                <p>بند 4: يلتزم العميل المشترك بعدم المماطلة أو التأخير في الدفعات المستحقة لشركة فوالا، والا لدى
                    شركة فوالا الحق في إيقاف الحساب.</p>
                ...
                <p>بند 7: لا يحق لشركة فوالا مسح الحساب نهائيا من على قاعدة بياناتها الا بعد ثلاثة شهور من إيقاف
                    الاشتراك.</p>
                <p>بند 8: في حالة فسخ الاشتراك من قبل العميل المشترك لا يحق له المطالبة بأي مبالغ مدفوعة مسبقا ويجب
                    على العميل المشترك ايضا استكمال الدفعات المتأخرة عليه كاملة بدون خصم أي مصاريف.</p>
                <p>بند 9: في حالة فسخ التعاقد من قبل شركة فوالا عليه ان يرد المبلغ المدفوع بالكامل للعميل المشترك
                    قبل نهاية مدة الاشتراك.</p>
                <p>بند 10: يجوز للعميل المشترك المطالبة باسترجاع اشتراكه في خلال عشرة أيام فقط من تاريخ بداية
                    الاشتراك.</p>
                <p>بند 11: تضاف أسماء ووصلات المشاريع المنجزة إلى دليل أعمال شركة فوالا تلقائيا.</p>
                <p>بند 12: عند قيام شركة فوالا بإضافة اي أضافات او تعديلات على التطبيق يجب عليه اعلام العميل المشترك
                    كتابيا او نصيا او إلكترونيا بإضافة هذا التحديث.</p>
                <p>بند 13: علي شركة فوالا استضافة النظام بخوادم شركة فوالا ويتمتع العميل المشترك بالمميزات الاتية:
                </p>
