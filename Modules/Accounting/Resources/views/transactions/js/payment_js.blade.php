<script type="text/javascript">
    $(document).ready(function() {
        ...
        sell_table = $('#sell_table').DataTable({
            ...
            "ajax": {
                "url": "/accounting/transactions/sales?type={{ Request::get('type') }}",
                "data": function(d) {
            ...
            "footerCallback": function(row, data, start, end, display) {
                ...
                for (var r in data) {
                    footer_sale_total += $(data[r].final_total).data('orig-value') ? parseFloat($(data[r].final_total)
                        .data('orig-value')) : 0;
                    footer_total_paid += $(data[r].total_paid).data('orig-value') ? parseFloat($(data[r].total_paid)
                        .data('orig-value')) : 0;
                    footer_total_remaining += $(data[r].total_remaining).data('orig-value') ? parseFloat($(data[r]
                        .total_remaining).data('orig-value')) : 0;
