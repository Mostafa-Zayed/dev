...
<section class="content-header">
    <h1>@lang('website::lang.add_review')</h1>
</section>
<section class="content">
    @component('components.widget', ['class' => 'box-solid'])
    <div class="pos-tab-content active">
        {!! Form::open(['url' => action([Modules\Website\Http\Controllers\WebsiteReviewController::class, 'store']), 'method' => 'post','files' => true]) !!}
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    {!! Form::label('',__('website::lang.job_' . $lang) . ' : *') !!}
                    {!! Form::text("job[$lang]",null, ['class' => 'form-control',
                    'placeholder' => __('website::lang.job_' . $lang)]); !!}
                </div>
            </div>
            @endforeach
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    {!! Form::label('',__('website::lang.rate') . ' : *') !!}
                    {!! Form::number("rate",1, ['class' => 'form-control',
                    'placeholder' => __('website::lang.rate'),'min' => 1,'max' => 5]); !!}
                </div>
            </div>
