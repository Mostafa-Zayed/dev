<section id="pricing" class="section-block" data-scroll-index="4">
    <div class="container">
        <div class="section-header">
            @if (!empty($settings))
                <h2>
                    @if (!empty($settings->getTranslations('section_packages_title')[app()->getLocale()]))
                        {{ $settings->getTranslations('section_packages_title')[app()->getLocale()] }}
                    @endif
                </h2>
                @if (!empty($settings->getTranslations('section_packages_description')[app()->getLocale()]))
        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                ...
                <ul class="nav pricing-btns-group mx-auto d-flex justify-content-center">
                    <li><a class="active btn" data-toggle="tab" href="#monthly">{{ __('website::lang.monthly') }}</a>
                    </li>
                    <li><a class="btn" data-toggle="tab" href="#yearly">{{ __('website::lang.yearly') }} <span
                                class="btn-badge">10% OFF</span></a></li>
                </ul>
            </div>
            <div class="col-md-12">
                                        ...
                                        <div class="pricing-card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="{{ route('business.getRegister') }}?package={{ $package->id }}"
                                                    class="btn btn-sm btn-block">{{ __('lang_v1.start_now') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End pricing table-->
                                    ...
                                    <div class="col-md-4">
                                        <div class="pricing-card">
                                            <header class="card-header">
                                                ...
                                                <span class="card-header-price">
                                                    <span class="simbole">$</span>
                                                    <span class="price-num">{{ round($package->price) }}</span>
