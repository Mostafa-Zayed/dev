...
<section class="content">
    ...
    @slot('tool')
    <div class="box-tools">
        <a class="btn btn-block btn-primary" href="{{route('features.create')}}"><i class="fa fa-plus"></i> @lang( 'messages.add' )</a>
    </div>
    @endslot
    @endcan
    ...
    @endcomponent
    <div class="modal fade feature_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
    </div>
</section>
@endsection
...
<script>
    $(document).ready(function() {
        ...
        // edit
        $(document).on('click', 'button.edit_feature_button', function(event) {
            $('div.feature_modal').load($(this).data('href'), function() {
                $(this).modal('show');
