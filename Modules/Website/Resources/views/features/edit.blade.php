<div class="modal-dialog" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => action([\Modules\Website\Http\Controllers\WebsiteFeatureController::class,'update'],[$id]), 'method' => 'post', 'id' => 'feature_add_form','files' => true ]) !!}
        @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::text("name[$lang]",$feature->getTranslations('name')[$lang], ['class' => 'form-control',
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea("description[$lang]", $feature->getTranslations('description')[$lang], ['class' => 'form-control','id' => "description_$lang"]); !!}
                    </div>
                </div>
                @endforeach
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::text("icon",$feature->icon, ['class' => 'form-control',
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('external_link',$feature->external_link,['class' => 'form-control']) !!}
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('website_template_id', $templates, $feature->website_template_id, ['placeholder' => __( 'messages.please_select' ), 'class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
