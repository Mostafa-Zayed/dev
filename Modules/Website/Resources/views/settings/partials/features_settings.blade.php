    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                {!! Form::text("section_features_title[$lang]",null, ['class' => 'form-control', 'required',
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                {!! Form::textarea("section_features_description[$lang]", null, ['class' => 'form-control','id' => "section_features_description_$lang"]); !!}
            </div>
        </div>
        @endforeach
        <div class="col-sm-12">
