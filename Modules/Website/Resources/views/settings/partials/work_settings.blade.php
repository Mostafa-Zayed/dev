    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                {!! Form::text("section_work_title[$lang]",null, ['class' => 'form-control', 'required',
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                {!! Form::textarea("section_work_description[$lang]", null, ['class' => 'form-control','id' => "section_work_description_$lang"]); !!}
            </div>
        </div>
        @endforeach
        <div class="col-sm-12">
