        ...
        @foreach (languages() as $lang)
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    {!! Form::text("section_questions_title[$lang]",isset($settings->getTranslations('section_questions_title')[$lang]) ? $settings->getTranslations('section_questions_title')[$lang] : null, ['class' => 'form-control',
        ...
        @foreach (languages() as $lang)
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    {!! Form::textarea("section_questions_description[$lang]", isset($settings->getTranslations('section_questions_description')[$lang]) ? $settings->getTranslations('section_questions_description')[$lang] : null, ['class' => 'form-control','id' => "section_questions_description_$lang"]); !!}
                </div>
            </div>
        @endforeach
        <div class="col-sm-12">
                ...
                <div class="file-input file-input-new">
                    ...
                    <div class="input-group file-caption-main">
                        ...
                        <div class="input-group-btn">
                            ...
                            <div tabindex="500" class="btn btn-primary btn-file"><i class="glyphicon glyphicon-folder-open"></i>&nbsp; <span class="hidden-xs">تصفح..</span><input accept="image/*" name="section_questions_image" type="file" id="section_questions_image"></div>
                        </div>
                    </div>
                </div>
