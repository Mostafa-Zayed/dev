<div class="modal-dialog" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => action([\Modules\Website\Http\Controllers\WebsiteScreenshotController::class,'update'],[$id]), 'method' => 'post', 'id' => 'screen_add_form','files' => true ]) !!}
        @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::text("name[$lang]",$screen->getTranslations('name')[$lang], ['class' => 'form-control',
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea("description[$lang]", $screen->getTranslations('description')[$lang], ['class' => 'form-control','id' => "description_$lang"]); !!}
                    </div>
                </div>
                @endforeach
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('status', ['1' => __('messages.yes'), '0' => __('messages.no')], $screen->status, ['placeholder' => __( 'messages.please_select' ), 'class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
                        {!! Form::label('',__('website::lang.is_home') . ' : *') !!}
                        {!! Form::select('is_home', ['1' => __('messages.yes'), '0' => __('messages.no')], $screen->is_home, ['placeholder' => __( 'messages.please_select' ), 'class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
                        {!! Form::label('',__('website::lang.demos') . ' : *') !!}
                        {!! Form::select('website_template_id', $templates, $screen->website_template_id, ['placeholder' => __( 'messages.please_select' ), 'class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="col-sm-12">
                <div class="form-group">
