...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected $moduleApiNamespace = 'Modules\Website\Http\Controllers\Api';
    ...
    {
        return 'api/v' . self::API_VERISON . '/' . self::PREFIX; 
    }
}
